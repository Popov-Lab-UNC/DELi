...
def parse_args():
    ...
    parser.add_argument('--raw_indexes', type=str, help='Path to the file containing dictionary mapping experimental IDs to raw index ranges')
...
def main():
    ...
    print(control_cols)
    raw_indexes = read_dict_from_file(args.indexes)
    print(raw_indexes)

    cube = DELi_Cube(df, indexes, control_cols, args.lib_size, raw_indexes)
    #print self data
